...
const PopularClass = () => {
    ...
    return (
        <div>
            <h1 className='text-lg md:text-4xl my-4 font-serif uppercase font-medium text-center'>Popular Classes</h1>
            <div className='grid md:grid-cols-3 gap-4 my-8'>
                {
                    classes.map(item =>
                        <div key={item._id} className="card w-full shadow-xl">
                            <figure><img className='h-56 w-[350px] rounded' src={item.image} /></figure>
